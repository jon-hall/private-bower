...
module.exports = function RepoCache(options) {
    ...
    function _getCachedRepo(repoName, repoUrl) {
        ...
        exec(checkRepoCommand, function(error) {
            if(error) {
                ...
                _cacheRepo(repoName, repoUrl, cacheRepoAddr).then(function() {
                        return {
                            name: repoName,
                            repo: cacheRepoAddr
                        };
            ...
            // Repo is cached, so we need to perform a 'git pull' then return the repo info
            _updateCachedRepo(repoName).then(function() {
                return {
                    name: repoName,
                    repo: cacheRepoAddr
                };
    ...
    function _cacheRepo(repoName, repoUrl, cacheRepoAddr) {
        var deferred = q.defer();
