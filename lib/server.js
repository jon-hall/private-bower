    ...
    if (!_config.disablePublic) {
        ...
        if (_repoCacheEnabled) {
            _repoCache = new RepoCache({
                ...
                minHoursBetweenUpdates: isNaN(_config.repositoryCache.minHoursBetweenUpdates) ?
                    24 : _config.repositoryCache.minHoursBetweenUpdates
            });
        }
    }
    ...
    app.get('/packages/:name', function (req, res) {
        ...
        if (cachedOrPrivatePackage) {
            cachedOrPrivatePackage = {
                ...
                lastUpdated: cachedOrPrivatePackage.lastUpdated
            };
        ...
        return _repoCache.getCachedRepo(repoName, existingPackage.url || existingPackage.repo,
            ...
            .then(function (pack) {
                var cachedPackage = {
                    ...
                    lastUpdated: pack.lastUpdated || existingPackage.lastUpdated
                };
                ...
                if (pack.requiresRegistration) {
                    ...
                    // Make sure we persist the 'lastUpdated' time if we aren't registering the package
                    _packageStore.setPackageLastUpdated(repoName, cachedPackage.lastUpdated);
                }
